<template>
  <header class="header-container" ref="headerRef">
    <div
      ...
      style="
        display: grid;
        grid-template-columns: minmax(100px, auto) minmax(500px, 1fr) minmax(
            100px,
            auto
          );
        gap: 20px;
      ...
      <div class="left-section" style="width: auto; min-width: 100px">
        ...
        <div v-if="menuVisible" class="dropdown-mega-menu" @click.stop>
          <div class="menu-container">
            ...
            <!-- Closing tag for menu-categories -->
            ...
            <div class="menu-subcategories">
              ...
              <div
                class="subcategory-panel"
                v-if="activeCategory === 'generators'"
              >
                <div class="subcategory-list">
                  <router-link
              ...
              <div
                class="subcategory-panel"
                v-if="activeCategory === 'electrical'"
              >
                <div class="subcategory-list">
                  <router-link
        ...
        <ul class="icon-links">
          ...
          <li class="header-item">
            <div class="icon-text">
              ...
              <router-link v-else to="/profile" class="icon-text">
                <img src="/images/header/profile-logo.svg" alt="Account" />
                <span v-if="user.displayName" class="profile-name">{{
                  user.displayName
                }}</span>
              </router-link>
            </div>
          ...
          <div class="region-selector" @click.stop="toggleRegionMenu">
            <span class="lang-code">{{
              (currentLocale && currentLocale.toUpperCase()) || "UK"
            }}</span>
